...
describe("Access Key Login Form", () => {
  ...
  beforeEach(() => {
    ...
    window.tlVendor = {
      accessKey: {
        action: "trustedlogin",
        provider: "test",
        tl_ak_nonce: "nonce",  // Fixed: removed asterisks
      },
    };
  ...
  it("renders and matches snapshot", () => {
    ...
    expect(consoleLogSpy).toHaveBeenCalledWith("Teams:", expect.any(Array));
  });
  ...
  it("shows list of sites if multiple redirects, no form yet", () => {
    window.tlVendor = {
      ...window.tlVendor,
      redirectData: {
        "7aa999a0091e000c6d075590f8eb400e2": {
